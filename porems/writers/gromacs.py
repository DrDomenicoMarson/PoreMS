...
class GromacsTopologyWriter(StructureWriter):
    ...
    """
    def write_legacy_topology(self, name=""):
        """Write a legacy-style helper topology from a slit snapshot.
        ...
        if self._snapshot.source_kind != "silica_slit":
            raise TypeError("Legacy topology output requires a silica-slit snapshot.")
