...
systems = {
    "0_0": pms.ExperimentalSiliconStateTarget(
        alpha_override=0.60,
        q2_fraction=0.0170,
        q3_fraction=0.1675,
    ),
    "9_1": pms.ExperimentalSiliconStateTarget(
        alpha_override=0.571,
        q2_fraction=0.0133,
        q3_fraction=0.1735,
        t2_fraction=0.0195,
        t3_fraction=0.0367,
    ),
    "8_2": pms.ExperimentalSiliconStateTarget(
        alpha_override=0.563,
        q2_fraction=0.0158,
        q3_fraction=0.1637,
        t2_fraction=0.0508,
        t3_fraction=0.0818,
    ),
    "7_3": pms.ExperimentalSiliconStateTarget(
        alpha_override=0.472,
        q2_fraction=0.0101,
        q3_fraction=0.1275,
        t2_fraction=0.0622,
        t3_fraction=0.1144,
    ),
    "6_4": pms.ExperimentalSiliconStateTarget(
        alpha_override=0.398,
        q2_fraction=0.0149,
        q3_fraction=0.0976,
        t2_fraction=0.0605,
        t3_fraction=0.1836,
...
def _random_seed_for_system(select, seed_base):
    ...
    -------
    seed : int or None
        Per-system seed forwarded to :class:`porems.AmorphousSlitConfig`.
    """
...
def do_stuff(select, seed_base=None):
    ...
    if select == "0_0":
        ...
        ligand = pms.SilaneAttachmentConfig(
            molecule=pms.Molecule("TPS", "TPS", str(SCRIPT_DIR / "TEPS.pdb")),
