...
version_ns = {}
exec(
    (Path(__file__).resolve().parents[1] / "porems" / "_version.py").read_text(encoding="utf-8"),
    version_ns,
)
...
html_theme_options = {
    ...
    'bootstrap_version': "3",
    'navbar_links': [("API", "api"), ("Molecule", "molecule"), ("Pore", "pore"), ("Slit Prep", "slit"), ("Pore shape examples", "shape_examples"),],
}
